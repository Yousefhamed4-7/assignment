...
export default function AdminNavbar(props)
{
    ...
    return(
        <div ref={nav} className={`admin-nav-bar position-relative ${props.class}`} style={{backgroundColor:"#343a40",color:"#bdc7cf",height:"100vh",overflow:"hidden",transition:"0.5s"}}>
            <p className="border-bottom pb-4 mt-4 text-center fw-bold fs-5">Dern Support | Admin</p>
            <div className="d-flex justify-content-start align-items-center gap-4 border-bottom pb-3">
                <img className="image w-25" src="/adminImage.webp" alt="admin photo" />
            ...
            <div className="d-flex flex-column align-items-center justify-content-start gap-1 mt-3">
                ...
                <NavbarLink  to="/admin/dashboard/tickets/all">
                    <i class="fa-solid fa-clipboard-list"></i>
                    <p className="m-0">All Tickets</p>
                </NavbarLink>
                <NavbarLink  to="/admin/dashboard/tickets/open" >
                    <i class="fa-regular fa-file"></i>
                    <p className="m-0">New Tickets</p>
                </NavbarLink>
                <NavbarLink  to="/admin/dashboard/tickets/resolved">
                    <i class="fa-solid fa-check-double"></i>
                    <p className="m-0">Resolved Tickets</p>
                </NavbarLink>
                <NavbarLink  to="/admin/dashboard/tickets/ongoing">
                    <i class="fa-solid fa-sync"></i>
                    <p className="m-0">Tickets In process</p>
                </NavbarLink>
                <NavbarLink  to="/admin/dashboard/tickets/unresolved">
                    <i class="fa-solid fa-xmark"></i>
                    <p className="m-0">Unresolved Tickets</p>
                </NavbarLink>
                <NavbarLink  to="/admin/dashboard/tickets/closed">
                    <i class="fa-solid fa-lock"></i>
                    <p className="m-0">Closed Tickets</p>
                </NavbarLink>
